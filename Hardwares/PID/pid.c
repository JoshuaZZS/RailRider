...
const float  controller_parameter[6][5] =
{
		...
		/* 飞轮平衡pid参数 */
    {0.055 , 0.00003,  0.026,  500 , 2000 },              		//外环速度环   
    {4.8 , 0.0,  0,  550 , 2000 },                           	//内环角度环       
    {34.0 ,  0.0,  0,  500 , 2000 },                         	//内环角速度环
		/* 飞轮差速转向pid参数 */
    {0.8 , 0.0,  0.0,  500 , 2000 },              						//外环速度环   
    {0.0 , 0.0,  0.0,  550 , 2000 },                         	//内环角度环       
    {0.0 , 0.0,  0.0,  500 , 2000 },                         	//内环角速度环
};
...
/**
  ...
  */
void _para_table(_PID *controller,uint8_t label)
{
